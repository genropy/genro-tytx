...
describe('TYTX XML', () => {
    describe('Encode', () => {
        it('should encode Decimal', () => {
            ...
            assert.equal(parseFloat(decoded.price.value.toString()), 100.5);
        });
        ...
        it('should handle self-closing tags for null values', () => {
            const data = {
                empty: {
                    attrs: { id: 1 },
                    value: null
            ...
            const result = toXml(data);
            assert.ok(result.includes('<empty') && result.includes('/>'), 'Should be self-closing');
        });
    });
    ...
    describe('Decode', () => {
        it('should decode Decimal', () => {
            ...
            assert.equal(result.price.value.toString(), '100.5');
        });
                ...
                invoice: {
                    ...
                    value: {
                        ...
                        items: {
                            attrs: {},
                            value: [
                                { attrs: { name: 'Item A' }, value: new DecimalLib('100.00') },
                                { attrs: { name: 'Item B' }, value: new DecimalLib('200.00') }
                            ]
                        }
                    }
                }
